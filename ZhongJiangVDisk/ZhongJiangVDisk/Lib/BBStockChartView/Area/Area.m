...
- (void)removeSeries:(Series *)series{
    [series removeFromSuperlayer];
    [self.theSeries removeObject:series];
}
...
- (void)drawAnimated:(BOOL)animated{
    ...
    [_leftAxis drawAnimated:NO];
    [_bottomAxis drawAnimated:NO];
...
- (void)redrawAnimated:(BOOL)animated{
    ...
    [_leftAxis redrawAnimated:NO];
    [_bottomAxis redrawAnimated:NO];
}
