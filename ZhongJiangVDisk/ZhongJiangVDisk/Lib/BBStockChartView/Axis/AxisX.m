...
- (void)drawAnimated:(BOOL)animated{
    ...
    CALayer* line = [BaseLayer layerOfLineFrom:CGPointZero to:CGPointMake(width+2, 0) withColor:[BBTheme theme].axisColor andWidth:1 animated:NO];
...
//            NSLog(@"Draw x: %d", i);
            CATextLayer* label = [BaseLayer layerOfText:text withFont:@"HelveticaNeue" fontSize:[BBTheme theme].xAxisFontSize andColor:[BBTheme theme].defTextColor];
            ...
            CALayer* dash = [BaseLayer layerOfLineFrom:CGPointMake(idxWidth/2.0+[BBTheme theme].axisYwidth/2.0, 0) to:CGPointMake(idxWidth/2+[BBTheme theme].axisYwidth/2.0, 5) withColor:[BBTheme theme].axisColor andWidth:1 animated:animated];
