...
//            NSLog(@"Draw x: %d", i);
            ...
            CALayer* dash = [BaseLayer layerOfLineFrom:CGPointMake(idxWidth/2, 0) to:CGPointMake(idxWidth/2, 5) withColor:[BBTheme theme].axisColor andWidth:1 animated:animated];
