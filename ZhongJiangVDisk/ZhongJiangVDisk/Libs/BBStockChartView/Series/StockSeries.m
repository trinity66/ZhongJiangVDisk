...
- (void)drawPoint:(NSUInteger)idx animated:(BOOL)animated{
    ...
    CALayer* lh = [BaseLayer layerOfLineFrom:CGPointZero to:CGPointMake(0, y1-y2+1) withColor:color andWidth:1 animated:animated];
    ...
    CALayer* oc = [BaseLayer layerOfLineFrom:CGPointZero to:CGPointMake(0, y1-y2+1) withColor:color andWidth:ocWidth animated:animated];
